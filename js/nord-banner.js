...
(function() {
  ...
  function fallbackBar() {
    ...
    '</div>' +
    '<div style="text-align:center;font-size:9px;color:#475569;background:#0a0a1a;padding:2px 0;font-family:Verdana,sans-serif">#AD · Paid partnership with NordVPN</div>';
  }
