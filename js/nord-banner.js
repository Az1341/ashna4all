...
<style>
/* ── BREAKING NEWS TICKER FIX ── */
/* Push ticker to start after sidebar on desktop */
@media(min-width: 769px) {
  /* Target all common ticker patterns from app.js/home.js */
  .gc-breaking,
  #gc-breaking,
  [class^="gc-break"],
  [id^="gc-break"],
  ...
  /* Content padding so ticker doesn't cover it */
  #gc-content {
...
/* Ensure sidebar nav buttons never disappear */
#gc-sidebar .sb-nav-link,
#gc-sidebar .sb-section,
#gc-sidebar .sb-section-label {
...
<style>
/* ══ FINAL TICKER + SIDEBAR FIX ══
   Ticker id = gc-breaking-ticker (confirmed from news.js)
   It inserts before #gc-canvas at top of body
   On desktop: push it right of sidebar
   Sidebar must always be on top
   ══════════════════════════════════ */

/* Sidebar always highest z-index */
#gc-sidebar {
  z-index: 500 !important;
}

/* Breaking ticker — desktop: start after sidebar */
@media(min-width: 769px) {
  #gc-breaking-ticker {
  ...
  /* Push page content down so ticker doesn't cover it */
  #gc-content {
    margin-top: 34px !important;
  }

  /* Sidebar logo area sits behind ticker — add padding at top */
  .sb-logo {
    padding-top: 52px !important;
  }
}

/* Mobile: ticker full width, sidebar slides over it */
@media(max-width: 768px) {
  #gc-breaking-ticker {
    position: fixed !important;
    top: 0 !important;
...
/* Sidebar nav always visible — never hidden */
#gc-sidebar .sb-section,
#gc-sidebar .sb-nav-link,
#gc-sidebar .sb-section-label,
#gc-sidebar .sb-divider {
  visibility: visible !important;
  opacity: 1 !important;
}
#gc-sidebar .sb-section { display: block !important; }
#gc-sidebar .sb-section-label { display: block !important; }
#gc-sidebar .sb-nav-link { display: flex !important; }
</style>
<style>
/* ── NORDVPN BAR — push right of sidebar on desktop ── */
@media(min-width: 769px) {
  #gc-nordvpn-bar {
    left: var(--sb-w) !important;
    right: 0 !important;
...
/* ── LEGAL FOOTER LINKS — always visible at bottom of sidebar ── */
.sb-footer {
  display: block !important;
  visibility: visible !important;
  opacity: 1 !important;
...
/* Also add visible footer bar at bottom of main content */
.gc-page-footer {
  margin-left: var(--sb-w);
...
.gc-page-footer a:hover { color: #2563eb; }
@media(max-width: 768px) {
  .gc-page-footer { margin-left: 0; padding-bottom: 80px; }
}
</style>

<!-- Visible footer with legal links -->
<div class="gc-page-footer">
  <span>© 2026 Ashna4All (A. Zafarani)</span>
  <a href="/about.html">About</a>
  <a href="/privacy.html">Privacy</a>
  <a href="/terms.html">Terms</a>
  <a href="/disclaimer.html">Disclaimer</a>
  <a href="mailto:info@goalcurrent.live">Contact</a>
  <span>⚽ Independent fan site · Not affiliated with FIFA, UEFA or Premier League</span>
</div>
<style>
/* ── MOBILE HAMBURGER — move below ticker ── */
@media(max-width: 768px) {
  .sb-hamburger {
    top: 42px !important; /* below 34px ticker */
  }
  #gc-content {
