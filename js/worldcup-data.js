const WC26 = {
  groups: {
    A: {
      name: "Group A",
      teams: [
        { name: "Mexico", flag: "🇲🇽", confederation: "CONCACAF", ranking: 16 },
        { name: "South Africa", flag: "🇿🇦", confederation: "CAF", ranking: 66 },
        { name: "Paraguay", flag: "🇵🇾", confederation: "CONMEBOL", ranking: 61 },
    ...
    B: {
      name: "Group B",
      teams: [
        { name: "USA", flag: "🇺🇸", confederation: "CONCACAF", ranking: 11 },
        { name: "Panama", flag: "🇵🇦", confederation: "CONCACAF", ranking: 49 },
        { name: "Colombia", flag: "🇨🇴", confederation: "CONMEBOL", ranking: 9 },
        { name: "Ghana", flag: "🇬🇭", confederation: "CAF", ranking: 60 }
      ]
    },
    C: {
      name: "Group C",
      teams: [
        { name: "Canada", flag: "🇨🇦", confederation: "CONCACAF", ranking: 38 },
        { name: "Honduras", flag: "🇭🇳", confederation: "CONCACAF", ranking: 79 },
    ...
    D: {
      ...
      teams: [
        ...
        { name: "Portugal", flag: "🇵🇹", confederation: "UEFA", ranking: 6 },
        { name: "Tanzania", flag: "🇹🇿", confederation: "CAF", ranking: 129 },
        { name: "Iraq", flag: "🇮🇶", confederation: "AFC", ranking: 58 }
      ]
    },
    E: {
      name: "Group E",
    ...
    G: {
      name: "Group G",
      teams: [
        { name: "France", flag: "🇫🇷", confederation: "UEFA", ranking: 2 },
        { name: "Nigeria", flag: "🇳🇬", confederation: "CAF", ranking: 39 },
        { name: "New Zealand", flag: "🇳🇿", confederation: "OFC", ranking: 97 },
        { name: "Costa Rica", flag: "🇨🇷", confederation: "CONCACAF", ranking: 47 }
      ]
    },
    H: {
      name: "Group H",
      teams: [
        ...
        { name: "Bahrain", flag: "🇧🇭", confederation: "AFC", ranking: 83 }
      ]
    },
    I: {
      name: "Group I",
      teams: [
        { name: "Argentina", flag: "🇦🇷", confederation: "CONMEBOL", ranking: 1 },
        { name: "Morocco", flag: "🇲🇦", confederation: "CAF", ranking: 14 },
        { name: "Ukraine", flag: "🇺🇦", confederation: "UEFA", ranking: 22 },
        { name: "Uzbekistan", flag: "🇺🇿", confederation: "AFC", ranking: 74 }
      ]
    },
    J: {
      name: "Group J",
