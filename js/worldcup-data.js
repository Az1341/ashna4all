...
(function () {
  ...
  ───────────────────────────────────────────── */
    ...
    {id:2  ,group:'A',home:'Korea Republic',away:'Czechia',date:'2026-06-12',bst:'03:00',venue:'Estadio Akron, Guadalajara',ukBroadcaster:'ITV'},
    {id:3  ,group:'B',home:'Canada',away:'Bosnia & Herzegovina',date:'2026-06-12',bst:'20:00',venue:'BMO Field, Toronto',ukBroadcaster:'BBC'},
    {id:4  ,group:'D',home:'USA',away:'Paraguay',date:'2026-06-13',bst:'02:00',venue:'SoFi Stadium, Los Angeles',ukBroadcaster:'BBC'},
    ...
    {id:6  ,group:'C',home:'Brazil',away:'Morocco',date:'2026-06-13',bst:'23:00',venue:'MetLife Stadium, New York/New Jersey',ukBroadcaster:'BBC'},
    ...
    {id:9  ,group:'E',home:'Germany',away:'Curaçao',date:'2026-06-14',bst:'18:00',venue:'NRG Stadium, Houston',ukBroadcaster:'ITV'},
    ...
    {id:12 ,group:'F',home:'Sweden',away:'Tunisia',date:'2026-06-15',bst:'03:00',venue:'Estadio BBVA, Monterrey',ukBroadcaster:'ITV'},
    ...
    {id:15 ,group:'G',home:'IR Iran',away:'New Zealand',date:'2026-06-15',bst:'21:00',venue:'SoFi Stadium, Los Angeles',ukBroadcaster:'BBC'},
    {id:16 ,group:'H',home:'Saudi Arabia',away:'Uruguay',date:'2026-06-15',bst:'23:00',venue:'Hard Rock Stadium, Miami',ukBroadcaster:'ITV'},
    ...
    {id:18 ,group:'I',home:'Iraq',away:'Norway',date:'2026-06-16',bst:'23:00',venue:'Gillette Stadium, Boston',ukBroadcaster:'BBC'},
    ...
    {id:23 ,group:'L',home:'Ghana',away:'Panama',date:'2026-06-18',bst:'00:00',venue:'BMO Field, Toronto',ukBroadcaster:'ITV'},
    {id:24 ,group:'K',home:'Uzbekistan',away:'Colombia',date:'2026-06-18',bst:'03:00',venue:'Estadio Azteca, Mexico City',ukBroadcaster:'BBC'},
    {id:25 ,group:'A',home:'Czechia',away:'South Africa',date:'2026-06-18',bst:'17:00',venue:'Mercedes-Benz Stadium, Atlanta',ukBroadcaster:'BBC'},
    {id:26 ,group:'B',home:'Switzerland',away:'Bosnia & Herzegovina',date:'2026-06-18',bst:'20:00',venue:'SoFi Stadium, Los Angeles',ukBroadcaster:'ITV'},
    ...
    {id:29 ,group:'D',home:'USA',away:'Australia',date:'2026-06-19',bst:'20:00',venue:'Lumen Field, Seattle',ukBroadcaster:'BBC'},
    {id:30 ,group:'C',home:'Scotland',away:'Morocco',date:'2026-06-19',bst:'23:00',venue:'Gillette Stadium, Boston',ukBroadcaster:'ITV'},
    ...
    {id:32 ,group:'D',home:'Türkiye',away:'Paraguay',date:'2026-06-20',bst:'04:00',venue:'Levi\'s Stadium, San Francisco Bay Area',ukBroadcaster:'ITV'},
    ...
    {id:36 ,group:'F',home:'Tunisia',away:'Japan',date:'2026-06-21',bst:'05:00',venue:'Estadio BBVA, Monterrey',ukBroadcaster:'BBC'},
    {id:37 ,group:'H',home:'Spain',away:'Saudi Arabia',date:'2026-06-21',bst:'17:00',venue:'Mercedes-Benz Stadium, Atlanta',ukBroadcaster:'BBC'},
    {id:38 ,group:'G',home:'Belgium',away:'IR Iran',date:'2026-06-21',bst:'20:00',venue:'SoFi Stadium, Los Angeles',ukBroadcaster:'ITV'},
    ...
    {id:41 ,group:'J',home:'Argentina',away:'Austria',date:'2026-06-22',bst:'18:00',venue:'AT&T Stadium, Dallas',ukBroadcaster:'BBC'},
    ...
    {id:44 ,group:'J',home:'Jordan',away:'Algeria',date:'2026-06-23',bst:'04:00',venue:'Levi\'s Stadium, San Francisco Bay Area',ukBroadcaster:'ITV'},
    {id:45 ,group:'K',home:'Portugal',away:'Uzbekistan',date:'2026-06-23',bst:'18:00',venue:'NRG Stadium, Houston',ukBroadcaster:'ITV'},
    {id:46 ,group:'L',home:'England',away:'Ghana',date:'2026-06-23',bst:'21:00',venue:'Gillette Stadium, Boston',ukBroadcaster:'BBC'},
    ...
    {id:49 ,group:'B',home:'Switzerland',away:'Canada',date:'2026-06-24',bst:'20:00',venue:'BC Place, Vancouver',ukBroadcaster:'ITV'},
    ...
    {id:52 ,group:'C',home:'Morocco',away:'Haiti',date:'2026-06-24',bst:'23:00',venue:'Mercedes-Benz Stadium, Atlanta',ukBroadcaster:'BBC'},
    {id:53 ,group:'A',home:'Czechia',away:'Mexico',date:'2026-06-25',bst:'02:00',venue:'Estadio Azteca, Mexico City',ukBroadcaster:'BBC'},
    {id:54 ,group:'A',home:'South Africa',away:'Korea Republic',date:'2026-06-25',bst:'02:00',venue:'Estadio BBVA, Monterrey',ukBroadcaster:'BBC'},
    {id:55 ,group:'E',home:'Curaçao',away:'Côte d\'Ivoire',date:'2026-06-25',bst:'21:00',venue:'Lincoln Financial Field, Philadelphia',ukBroadcaster:'BBC'},
    ...
    {id:58 ,group:'F',home:'Tunisia',away:'Netherlands',date:'2026-06-26',bst:'00:00',venue:'Arrowhead Stadium, Kansas City',ukBroadcaster:'BBC'},
    {id:59 ,group:'D',home:'Türkiye',away:'USA',date:'2026-06-26',bst:'03:00',venue:'SoFi Stadium, Los Angeles',ukBroadcaster:'ITV'},
    ...
    {id:61 ,group:'I',home:'Norway',away:'France',date:'2026-06-26',bst:'20:00',venue:'Gillette Stadium, Boston',ukBroadcaster:'ITV'},
    ...
    {id:64 ,group:'H',home:'Uruguay',away:'Spain',date:'2026-06-27',bst:'01:00',venue:'Estadio Akron, Guadalajara',ukBroadcaster:'ITV'},
    {id:65 ,group:'G',home:'Egypt',away:'IR Iran',date:'2026-06-27',bst:'04:00',venue:'Lumen Field, Seattle',ukBroadcaster:'BBC'},
    {id:66 ,group:'G',home:'New Zealand',away:'Belgium',date:'2026-06-27',bst:'04:00',venue:'BC Place, Vancouver',ukBroadcaster:'BBC'},
    {id:67 ,group:'L',home:'Panama',away:'England',date:'2026-06-27',bst:'22:00',venue:'MetLife Stadium, New York/New Jersey',ukBroadcaster:'ITV'},
    ...
    {id:70 ,group:'K',home:'Congo DR',away:'Uzbekistan',date:'2026-06-28',bst:'00:30',venue:'Mercedes-Benz Stadium, Atlanta',ukBroadcaster:'BBC'},
    {id:71 ,group:'J',home:'Algeria',away:'Austria',date:'2026-06-28',bst:'03:00',venue:'Arrowhead Stadium, Kansas City',ukBroadcaster:'BBC'},
